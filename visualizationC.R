...
#Step C: Which State had the Most Murders – bar charts4)	Calculate the number of murders per state 
5)	Generate a bar chart, with the number of murders per state Hint: use the geom_col function
